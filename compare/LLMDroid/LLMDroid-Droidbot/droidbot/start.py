...
from policy import input_policy
...
def parse_args():
    ...
    parser.add_argument("--code_coverage", action="store", dest="code_coverage", choices=["androlog", "jacoco", "time"], default="androlog",
                        help="Using which tool to monitor real-time code coverage")
