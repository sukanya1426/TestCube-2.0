...
public class AiClient {
    ...
    public static void InitAgent(AlgorithmType agentType, String packagename, boolean useCodeCoverage) {
        singleton.fgdsaf5d(agentType.value(), packagename, 0, useCodeCoverage);
    }
    ...
    private native void fgdsaf5d(int b7, String b2, int t, boolean useCodeCoverage);
