...
///Use text inside widget for embedding and identifying widget, which is the default implementation
    ...
    public:
        ...
        std::string getContentDesc() { return this->_contextDesc;}

        std::string getTextualInfo() {return this->_info;}
        ...
        uintptr_t getMyHashcode() { return _myHashcode; }
    ...
    protected:
        ...
        uintptr_t _hashcode{};
        uintptr_t _myHashcode{};    // use hashcode and bounds as new hash
