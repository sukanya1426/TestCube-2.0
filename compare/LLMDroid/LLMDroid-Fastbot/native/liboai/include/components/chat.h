	...
	class Conversation final {
		public:
			...
			*/
			...
			/**
			 * @brief Find the first user data from the beginning, and erase it.
			 */
			LIBOAI_EXPORT bool PopFirstUserData() & noexcept(false);
			...
			*/
			...
			/**
			 * @brief Find the first response from the beginning, and erase it.
			 */
			LIBOAI_EXPORT bool PopFirstResponse() & noexcept(false);
