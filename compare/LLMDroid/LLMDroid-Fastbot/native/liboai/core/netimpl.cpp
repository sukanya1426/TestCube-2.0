...
void liboai::netimpl::Session::Prepare() {
	...
	//fastbotx::callJavaLogger(this->url_str.c_str());
	...
	e[4] = curl_easy_setopt(this->curl_, CURLOPT_ACCEPT_ENCODING, "");
		...
		//fastbotx::callJavaLogger("CURLOPT_SSL_VERIFYPEER");
		//e[5] = curl_easy_setopt(this->curl_, CURLOPT_SSL_OPTIONS, CURLSSLOPT_NO_REVOKE);
		curl_easy_setopt(this->curl_, CURLOPT_SSL_VERIFYPEER, false);
	...
	//fastbotx::callJavaLogger(this->header_string_.c_str());
