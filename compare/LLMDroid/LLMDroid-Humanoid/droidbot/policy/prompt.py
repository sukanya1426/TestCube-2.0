...
What action should I perform next to test the function mentioned above?
"""

answer_format_test = """
Your response should include the selected element's id and the action to be performed on that element.
The available types of actions include: click (0), long press (1), swipe from top to bottom (2), swipe from bottom to top (3), swipe from left to right (4), and swipe from right to left (5).
...
If you believe no more action is needed, the value of "Element Id" should be -1, the value of "Action Type" should be 0
